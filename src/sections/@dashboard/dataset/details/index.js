        ...
        <Grid container>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            <Box sx={{ textAlign: { sm: 'right' } }}>
              ...
              <Typography variant="h6">{`INV-${datasetNumber}`}</Typography>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            ...
            <Typography variant="body2">{datasetFrom.name}</Typography>

            <Typography variant="body2">{datasetFrom.address}</Typography>

            <Typography variant="body2">Phone: {datasetFrom.phone}</Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={6} sx={{ mb: 5 }}>
            ...
            <Typography variant="body2">{datasetTo.name}</Typography>

            <Typography variant="body2">{datasetTo.address}</Typography>

            <Typography variant="body2">Phone: {datasetTo.phone}</Typography>
          </Grid>
